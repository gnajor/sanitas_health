export async function apiCom(action, data){
    ...
    switch(action){
        ...
        case "getPatientsAndRecord": {
            options.method = "GET";
            console.log(data);
            const resource = await fetcher(`../../api/records?patient=${data}`, options);
            return resource; 
        }
        ...
        case "bookAppointment": {
            options.method = "POST";
            options.body = data;
            const resource = await fetcher(`../../api/appointmentBooking`, options);
            return resource;
        }
        ...
        case "createMedicalRecord": {
            options.method = "POST";
            options.body = data;
            const resource = await fetcher(`../../api/createRecord`, options);
            return resource;
        }
